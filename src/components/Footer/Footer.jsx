            ...
            <div className="bg-foot-bg bg-no-repeat bg-cover pt-20 pb-16 px-5">
                <div className="max-w-[1400px] m-auto">
                    <div className="flex justify-center items-center">
                        ...
                        <span className="lg:text-5xl text-4xl font-semibold"> SHOP</span>
                    </div>
                    <div className="py-5">
                        <p className="max-w-[370px] mx-auto text-center">Riverside Building, County Hall, Bishop’s, London SE1 7PB, United Kingdom</p>
                    </div>
                    <div className="md:max-w-lg sm:max-w-md max-w-sm mx-auto">
                        <form onSubmit={handlesubscribe} className="flex justify-center items-center">
                            <input className="h-12 rounded-l-md outline-none bg-white text-[#373a3c] px-4 py-2 w-full border" type="email" name="" placeholder="Email" required />
